...
function slidesInitial (str) {
    ...
    var splitInsertRegExp = /(.*(?:&lt;){1,}insert(?:\s){0,}slide.*)((?:&lt;){1,}.*)/gi;
    str = str.replace(splitInsertRegExp, "$1</p>\n\r\n<p><strong>$2");

    /* END NEW REGEX */

    // Insert Slide edge cases / Capitalization Edge Cases
    var insertSlideRegExp1 = new RegExp('.*(?:&lt;){1,}.*slide(?:&gt;){1,}.*', 'gi');
    str = str.replace(insertSlideRegExp1, "&lt;&lt;insert slide&gt;&gt;");
    
    var insertSlideRegExp2 = new RegExp('.*(?:&lt;){1,}Slide(?:\s){0,}((?:\d){0,}).*', 'gi');
    str = str.replace(insertSlideRegExp2, "&lt;&lt;insert slide $1&gt;&gt;");

    var insertSlideRegExp2 = new RegExp('.*(?:&gt;){1,}Slide(?:\s){0,}((?:\d){0,}).*', 'gi');
    str = str.replace(insertSlideRegExp2, "&lt;&lt;insert slide $1&gt;&gt;");
    
    var insertSlideRegExp3 = new RegExp('.*(?:&gt;){1,}.*slide(?:\s){0,}((?:\d){0,}).*', 'g');
    str = str.replace(insertSlideRegExp3, "&lt;&lt;insert slide $1&gt;&gt;");
    
    var insertSlideRegExp4 = new RegExp('.*(?:&gt;){1,}.*Slide(?:\s){0,}((?:\d){0,}).*', 'g');
    str = str.replace(insertSlideRegExp4, "&lt;&lt;insert slide $1&gt;&gt;");
    
    var insertSlideRegExp5 = /.*(?:&lt;){1,}insert.*slide (\d+).*/gi;
    ...
    var insertSlideRegExp6 = /.*(?:&lt;){1,}.*insert(?:\s){0,}slide(?:\s){0,}((?:\d){0,}).*/gi;
