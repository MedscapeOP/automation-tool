...
function mediaInfo(articleID, videoRSSLink, componentNumber=null) {
    ...
    if (componentNumber) {
        ...
        Mobile Start: en/thumbnail_library/mobile_start/org/${currentYear}/${articleID}__${componentNumber + 1}_start.png
        Video RSS Location Mobile App: ${videoRSSLink}
    
        VALIDATOR LINK: https://api.staging.medscape.com/contentservice/video/validate/results?path=en/pi/editorial/studio/configs/${currentYear}/education/${articleID}/${articleID}__${componentNumber + 1}.json
        `;
    } else {
        result = `
